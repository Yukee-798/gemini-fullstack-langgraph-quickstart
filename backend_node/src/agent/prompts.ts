 ...
 */
export function getQueryWriterInstructions(params: {
  numberQueries: number;
  currentDate: string;
  researchTopic: string;
}): string {
  const { numberQueries, currentDate, researchTopic } = params;
 ...
 */
export function getWebSearcherInstructions(params: {
  researchTopic: string;
  currentDate: string;
}): string {
  const { researchTopic, currentDate } = params;
...
/**
 * Reflection instructions template
 */
export function getReflectionInstructions(params: {
  researchTopic: string;
  summaries: string;
}): string {
  const { researchTopic, summaries } = params;
...
/**
 * Answer instructions template
 */
export function getAnswerInstructions(params: {
  currentDate: string;
  researchTopic: string;
  summaries: string;
}): string {
  const { currentDate, researchTopic, summaries } = params;
